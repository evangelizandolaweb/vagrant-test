...
Vagrant.configure("2") do |config|
    config.vm.define :guest do |guest_config|
            ...
            guest_config.vm.network :private_network, ip: "50.50.10.2"
            ...
            #guest_config.vm.hostname = "urbania"
            #guest_config.hostmanager.aliases = %w(local.urbania.ec local.m.urbania.ec local.urbania.online)
